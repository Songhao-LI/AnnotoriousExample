...
const Annotorious = dynamic(() =>
  import('@annotorious/react').then((mod) => mod.Annotorious), { ssr: false }
);
...
export default function App() {
  ...
  const toolkitItems = [
    { name: "Move", tool: undefined, icon: <FiMove size={22} strokeWidth={1.5}/> },
    { name: "Polygon", tool: "polygon", icon: <LiaDrawPolygonSolid size={24} /> },
  ...
  return (
    <Annotorious>
      <div className="flex gap-2 px-2 py-1" style={{width: '100%', height: '40px', position: 'relative'}}>
